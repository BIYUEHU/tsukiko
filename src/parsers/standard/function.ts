...
export class FunctionParser<T extends (...args: unknown[]) => unknown> extends Parser<T> {
  ...
  public async(isAsync: boolean = true) {
    this.isAsync = isAsync;
    return this;
  }

  public arrow(isArrow: boolean = true) {
    this.isArrow = isArrow;
    return this;
  }

  public generator(isGenerator: boolean = true) {
  ...
  public constructed(isConstructor: boolean = true) {
