...
> **new AnyParser**\<`T`\>(): [`AnyParser`](AnyParser.md)\<`T`\>

#### Returns

[`AnyParser`](AnyParser.md)\<`T`\>
...
> **describe**(`description`): [`AnyParser`](AnyParser.md)\<`T`\>
...
> **empty**(): [`AnyParser`](AnyParser.md)\<`T`\>
...
> **lang**(`value`): [`AnyParser`](AnyParser.md)\<`T`\>
...
> **title**(`title`): [`AnyParser`](AnyParser.md)\<`T`\>
