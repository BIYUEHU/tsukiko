...
- [`Parser`](Parser.md)\<`never`\>

## Constructors

### new NeverParser()

> **new NeverParser**(): [`NeverParser`](NeverParser.md)
...
[src/parsers/never.ts:8](https://github.com/BIYUEHU/tsukiko/blob/aa7a414bb89555b3910dd9d229f505891bded4ee/src/parsers/never.ts#L8)

## Methods

### check()

> **check**(`input`): `input is never`
...
> **default**(`value`): [`Parser`](Parser.md)\<`never`\>
...
> `protected` **defaultHandle**(`input`): `never`
...
> **describe**(`description`): [`NeverParser`](NeverParser.md)
...
> **empty**(): [`NeverParser`](NeverParser.md)
...
> **lang**(`value`): [`NeverParser`](NeverParser.md)
...
> **parseSafe**(`input`): [`ParserSafeReturn`](../type-aliases/ParserSafeReturn.md)\<`never`\>
...
[`ParserSafeReturn`](../type-aliases/ParserSafeReturn.md)\<`never`\>
...
> **title**(`title`): [`NeverParser`](NeverParser.md)
