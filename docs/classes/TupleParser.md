...
[src/parsers/tuple.ts:36](https://github.com/BIYUEHU/tsukiko/blob/aa7a414bb89555b3910dd9d229f505891bded4ee/src/parsers/tuple.ts#L36)
...
> **default**(`value`): [`Parser`](Parser.md)\<[`TupleParserInfer`](../type-aliases/TupleParserInfer.md)\<`S`\>\>
...
> **empty**(): [`TupleParser`](TupleParser.md)\<`S`\>
